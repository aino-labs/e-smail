...
// UpdateProfile дополнительно умеет обновлять accept_anonymous.
// acceptAnonymous == nil ⇒ поле не трогаем (PATCH-семантика), как и для
// остальных необязательных полей.
...
func (r *Repository) FindByID(ctx context.Context, userID int64) (*models.User, error) {
	...
	user := &models.User{}
	// Колонка NOT NULL, поэтому сканируем в bool и берём адрес: в модели
	// лежит *bool только из-за PATCH-семантики UpdateProfile.
